...
json = jsonlite::read_json(paste0(wdir, "/", sra, "_assembly_data_report.jsonl"))
...
```{r mapping, echo = F}
mapping = readLines(paste0(wdir, "/mapping/", sra, "_mapping.stats.tsv"))
...
```{r loadingSV, echo = F}
sniffles = read.vcfR(paste0(wdir, "/", sra, "_sniffles_noBND.vcf"))
...
```{r loadingSV, echo = F}
merged = read.vcfR(paste0(wdir, "/", sra, "_merged.vcf"))
