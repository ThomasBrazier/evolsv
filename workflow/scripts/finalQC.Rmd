...
```{r, echo = TRUE}
cat("Absolute number of calls merged with Jasmine:", sum(fix.merged$jasmine), "\n")

cat("Proportion of calls merged with Jasmine:", sum(fix.merged$jasmine) / nrow(fix.merged), "\n")
```
